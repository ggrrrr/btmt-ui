        ...
        <v-container fill-height no-gutters class="ma-0 mp-0">
            <v-row>
                <v-col no-gutters cols="6" sm="6" md="4">
                    <BtnLoadData :disabled="refs.loading" @click="loadData" text="Load people">
                    </BtnLoadData>
                </v-col>
                <v-col no-gutters cols="6" sm="6" md="4">
            ...
            <v-row>
                <v-col no-gutters cols="5" class="">
                    <InputTextsList :list="searchTextFields.list" @click="loadData" label="Names" hint="Email or names">
                    </InputTextsList>
