<template>
    <v-main>
        <v-form>
            ...
            <v-file-input width="10" density="compact" variant="solo" rounded="xl" color="primary" show-size
                @change="formChange" v-model="refs.file.fileForm" type='file' name="image" label="Image file"
                @update="inputFileUpload">
